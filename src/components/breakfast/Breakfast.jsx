...
<div className="container data">
        <div className="row ">
          ...
          <div className=" col-10 edit shadow p-3 mb-5 rounded ">
        <div className="bg-white mt-4 p-3 ">
          <div className="row">
            <div className="col-9">
            <p href="#" className=" d-flex justify-content-start   "><h5 className=" text-secondary me-1 ">Breakfast </h5>&#10095;<h5 className="text-black ms-1 ">Customer Details</h5> </p> 
       
            </div>
            <div className="col-3">
            <div className=" d-flex justify-content-end ">
  <button className="btn text-white " type="button"><span><Icon icon="carbon:add-filled" className="mb-1  " width="12" height="12" /></span>Add</button></div>
            </div>
          </div>
          <div className="row">
            <div className="col-9">
        <p className="all">CUSTOMER DETAILS</p>  
            </div>
            <div className="col-3">
  ...
  <thead>
    <tr>
      ...
      <th scope="col" className="text-center all">ACTIONS</th>
    </tr>
  </thead>
  <tbody>
  <tr>
